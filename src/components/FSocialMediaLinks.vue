<template>
    <ul class="f-social-media-links no-markers">
        <li>
            <a href="#" target="_blank" rel="nofollow" title="Globe on Discord">
                <icon data="@/assets/svg/social-media/discord.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="#" target="_blank" rel="nofollow" title="Globe on Twitter">
                <icon data="@/assets/svg/social-media/twitter.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="#" target="_blank" rel="nofollow" title="Globe on Reddit">
                <icon data="@/assets/svg/social-media/reddit.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://github.com/chain4travel" target="_blank" rel="nofollow" title="Globe on Github">
                <icon data="@/assets/svg/social-media/github.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="#" target="_blank" rel="nofollow" title="Globe on Medium">
                <icon data="@/assets/svg/social-media/medium.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="#" target="_blank" rel="nofollow" title="Globe on Linkedin" class="linkedin">
